...
import { MessageSquareQuote, Code, Laptop, Database, ArrowRight } from "lucide-react"
        ...
        <section className="space-y-6 pb-8 pt-12 md:pb-12 md:pt-24 lg:py-32">
          <div className="container flex max-w-[64rem] flex-col items-center gap-4 text-center">
            ...
            <p className="max-w-[42rem] leading-normal text-muted-foreground sm:text-xl sm:leading-8">
              A modern, developer-friendly platform for managing testimonials. Create forms, collect feedback, and
          ...
          <div className="mx-auto grid max-w-5xl gap-8 md:grid-cols-3">
            <div className="flex flex-col items-center space-y-2 rounded-lg border p-6 shadow-sm transition-all hover:shadow-md">
              ...
              <p className="text-center text-muted-foreground">
                Create shareable forms to collect testimonials from your clients with ease.
              </p>
            </div>
            <div className="flex flex-col items-center space-y-2 rounded-lg border p-6 shadow-sm transition-all hover:shadow-md">
              <div className="rounded-full bg-primary/10 p-3">
        ...
        <section className="container py-8 md:py-12 lg:py-24 bg-muted/50">
          <div className="mx-auto max-w-5xl">
            <div className="mb-12 text-center">
              <h2 className="text-3xl font-bold tracking-tight sm:text-4xl md:text-5xl">Available Components</h2>
              <p className="mt-4 text-lg text-muted-foreground">Choose from multiple testimonial display options</p>
            </div>
            ...
            <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
              <div className="rounded-lg border bg-card p-6 shadow-sm transition-all hover:shadow-md">
                ...
                <p className="mb-4 text-muted-foreground">
                  A responsive carousel slider that showcases testimonials one at a time with smooth transitions.
                </p>
              ...
              <div className="rounded-lg border bg-card p-6 shadow-sm transition-all hover:shadow-md">
                ...
                <p className="mb-4 text-muted-foreground">
                  Display multiple testimonials in a responsive grid layout with filtering options.
                </p>
                <div className="flex justify-between">
                  <span className="text-sm text-muted-foreground">Grid Layout</span>
                  <span className="text-sm text-muted-foreground">Filterable</span>
              ...
              <div className="rounded-lg border bg-card p-6 shadow-sm transition-all hover:shadow-md">
                ...
                <p className="mb-4 text-muted-foreground">
                  Embed a customizable form to collect testimonials directly on your website.
                </p>
                <div className="flex justify-between">
                  <span className="text-sm text-muted-foreground">Customizable</span>
                  <span className="text-sm text-muted-foreground">Validated</span>
                  <span className="text-sm text-muted-foreground">Multi-step</span>
                </div>
              </div>
            </div>
